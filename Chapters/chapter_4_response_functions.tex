...
\begin{align}
    ...
    \prob{P}_\alpha^{\RV{Y}_i|\RV{H}\RV{D}_i} &= \prob{P}_\alpha^{\RV{Y}_1|\RV{G}\RV{D}_1} & \forall \alpha\in C, i\in \mathbb{N}
\end{align}
...
\subsubsection{Aside: combs may be the output of the ``fix'' operation}

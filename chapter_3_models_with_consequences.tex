...
We suppose that we are, at the outset, given a few basic ingredients: a set of choices $C$, a set of consequences $\Omega$ and a utility function $u:\Omega\to \mathbb{R}$. We call these ingredients a ``decision problem''.

...
Any model of a decision problem must have a number of basic properties. The fact that there is a set of choices to be compared with reference to their consequences implies:
\begin{enumerate}

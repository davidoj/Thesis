...
\begin{definition}[Probability set model of a statistical decision problem]
A probability set model of a statistical decision problem is a tuple $(\prob{P}_{C\times H}, \RV{X},\RV{Y},\RV{D})$ where $\prob{P}_{C\times H}$ is a probability set indexed by elements of $C\times H$ on $(\Omega,\sigalg{F})$, $\RV{X}:\Omega\to X$ are the observations, $\RV{Y}:\Omega\to Y$ are the consequences and $\RV{D}:\Omega\to D$ are the decisions. $\prob{P}_{C\times H}$ must observe the following conditional independences:
\begin{align}
...
Given a probability set model of a statistical decision problem is a tuple $(\prob{P}_{C\times H}, \RV{X},\RV{Y},\RV{D})$ and a utility $u:Y\to \mathbb{R}$, the induced loss $l:D\times H\to \mathbb{R}$ is defined as
\begin{align}
...
Given a probability set model $(\prob{P}_{C\times H}, \RV{X},\RV{Y},\RV{D})$ of a statistical decision problem along with a utility $u:Y\to \mathbb{R}$, the expected utility for each choice of decision rule $\alpha\in C$ and hypothesis $h\in H$ pair is equal to the negative risk of the decision rule and hypothesis pair.
\end{theorem}
...
Given a Bayesian probability set model $(\prob{P}_{C}, \RV{X},\RV{Y},\RV{D},\RV{H})$ of a statistical decision problem along with a utility $u:Y\to \mathbb{R}$, the expected utility for each choice of decision rule $\alpha\in C$ is equal to the negative Bayes risk of that decision rule relative to the prior $\prob{P}_C^{\RV{H}}$.
\end{theorem}

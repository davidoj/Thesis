...
Thus far, we haven't dwelt on what it means for a probability measure to ``describe'' or ``represent'' something. In one view, probability measures constrain the behaviour of long sequences or ensembles of observations taken under identical conditions; in this view long sequences of random variables represent ``allowable'' sequences of observations. Alternatively, the probability distribution of a random variable could be a forecast of an observation associated with that variable.

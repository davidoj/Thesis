...
An infinite length sequence $\RV{X}_1,\RV{X}_2,...$ is exchangeable if $\RV{X}_1,...\RV{X}_n$ is exchangeable for all $n$.
...
\begin{lemma}[Functionally exchangeable sequences with exchangeable choices induce exchangeable sequences]
...
\begin{definition}[Infinitely exchangeably extendable]
...
\begin{definition}[Infinitely functionally exchangeably extendable]
...
\todo[inline]{I think it is the case that functionally exchangeable + non-interfering implies infinitely functionally exchangeably extendable, but not proved yet. Needs something like the Kolmogorov extension theorem}

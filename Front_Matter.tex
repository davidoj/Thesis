...
{\bfseries
\LARGE{Statistical Causal Modelling and Decision Theory}\\
\bigskip
\large{}
}
...
The assumption of \emph{precedent} is the assumption that ``whatever we can do has been done before'', and is weaker than the assumption of CIIR sequences. We show that the assumption of precedent in conjunction with an assumption of absolute continuity can yield a conclusion of CIIR sequences when the data displays the right kind of conditional independence. The assumption of absolute continuity is related to a conventional interpretation of structural causal models and shows how structural models might support causal inference even without a semantics of intervention.
\bigskip

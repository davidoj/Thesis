...
\section{Combs and response conditionals with data-dependent actions}\label{sec:data_dependent}
...
Unlike conditional probabilities, where marginalising yields other conditional probabilities, marginals of combs generally fail to be combs. The exception is when the ``last'' output wire is marginalised, in which case marginalising an $n$-comb yields an $n-1$-comb.

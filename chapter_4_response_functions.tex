...
\begin{align}
    \mathrm{insert}(\prob{P}_\alpha^{\RV{D}_{[n-1]}|\RV{Y}_{[n-1]}},\prob{P}_C^{\RV{Y}_{[n]}\combbreak \RV{D}_{[n]}})(y_n|d_1) &= \prob{P}_C^{\RV{Y}_{[n]}\combbreak \RV{D}_{[n]}}(y_n|d_{[1,n]},d_1)\prob{P}_\alpha^{\RV{D}_{[1,n]}|\RV{Y}_{[n-1]}}(d_{[1,n]}|y_{[n-1]})
\end{align}
\end{definition}
...
\subsection{Representation of decision problems with dependence on observations}

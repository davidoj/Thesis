...
\begin{align}
    ...
    &\overset{\prob{Q}}{\cong} \tikzfig{kernel_Q_fac_with_idents_idepped}\\
...
The condition $\RV{YI}\CI^e_{\prob{P}_C} \RV{C}|\RV{D}$ alone does \emph{not} imply the conclusion of Theorem \ref{th:cc_ind_treat}. 

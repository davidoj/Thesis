...
\newcommand{\node}[1]{\ensuremath{\overset{\sim}{\RV{#1}}}}
\newcommand{\graph}[1]{\ensuremath{\overset{\sim}{\mathcal{#1}}}}
...
% Decision Theoretic Foundations for Causal Modelling
...
\input{chapter_3_models_with_consequences}
\input{chapter_4_response_functions}
% \input{chapter_5_cc_sdt}
% \input{chapter_5_interventions_counterfactuals}
\input{chapter_5_other_causal_inference}
\input{chapter_6_discussion}

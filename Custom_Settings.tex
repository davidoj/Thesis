...
\newcommand{\PA}[2]{\ensuremath{\mathrm{Pa}_{#1}(#2)}}
\newcommand{\ND}[2]{\ensuremath{\mathrm{ND}_{#1}(#2)}}
\newcommand{\CH}[2]{\ensuremath{\mathrm{Ch}_{#1}(#2)}}
\newcommand{\DE}[2]{\ensuremath{\mathrm{De}_{#1}(#2)}}
